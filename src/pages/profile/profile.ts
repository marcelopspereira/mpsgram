...
import { ModalPostPage } from "../modal-post/modal-post";
/**
...
export class ProfilePage {
  ...
  constructor(public navCtrl: NavController, public authFire: AngularFireAuth, public modalCtrl: ModalController) {
  ...
  presentModal(user_id: number, username: string, profile_img: string, post_img: string) {
    let modal = this.modalCtrl.create(ModalPostPage,
      {// Send data to modal
        user_id: user_id,
        username: username,
